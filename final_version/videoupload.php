...
if(basename($_FILES["fileToUpload"]["name"]==null)){
	...
	if($videoFileType != "webm" && $videoFileType != "OGG" && $videoFileType != "ogg" && $videoFileType != "WEBM"
			&& $videoFileType != "mp4" && $videoFileType != "MP4") {
				echo "<h2>Sorry, only mp4, webm and ogg files are allowed.</h2>";
				$uploadOk = 0;
	}
